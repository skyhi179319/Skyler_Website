...
<div class="navbar">
    ...
    <div class="subnav">
        ...
        <a class="Extra" href="http://localhost:3306/Pages/Games/Canvas_2.php">Canvas - Extra</a>
        <a class="Elite" href="#">Canvas - Elite</a>
        <a class="Standard" href="http://localhost:3306/Pages/Games/Canvas/Graduation.php">Canvas - Graduation</a>
        </div>
        </div>
        <div class="dropdown">
        <button class="dropbtn">Canvas Animation</button>
        <div class="dropdown-content">
        <a class="Standard" href="http://localhost:3306/Pages/Games/Canvas/Animation.php">Canvas Animation</a>
        </div>
        </div>
        <div class="dropdown">
